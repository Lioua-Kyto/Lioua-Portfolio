...
export default async function OpengraphImage() {
  ...
  return new ImageResponse(
    ...
    >
      ...
      {/* The keynote labels, not the full ones. `short` exists for exactly
          this: a card 1200px wide cannot carry "average cached API latency
          under load" three times, and the long labels overran the frame, took
          the third proof off the edge with them, and left the card reading as
          a screenshot of something broken. */}
      <div
        style={{
          display: "flex",
          justifyContent: "space-between",
