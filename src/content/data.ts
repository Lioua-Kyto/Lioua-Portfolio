  ...
  work: [
    {
      ...
      erd: {
        title: "Four kinds of provider, one listing table",
        caption:
          "A host, a hostel, a hotel and an agency are four different businesses with four different profiles, and every one of them puts the same kind of thing up for booking. The profile is where they differ; the listing is where they are the same.",
        columns: [
          {
            title: "Who is on it",
            entities: [
              ...
              },
              {
                id: "host",
                name: "HostProfile",
                fields: ["user (1:1)", "type", "national_id"],
                kind: "owned",
              },
              {
                id: "biz",
                name: "Hotel / Hostel / Agency profile",
                fields: [
                  "user (1:1)",
                  "shared business base",
                  "nrc, nif (registration)",
                  "stars (hotels only)",
                ],
                kind: "owned",
              },
          ...
          },
          {
            ...
            entities: [
              {
                id: "listing",
                name: "Listing (polymorphic)",
                fields: [
                  "owner",
                  "price, quantity, max_guests",
                  "state, province",
              ...
              {
                id: "amen",
                name: "Amenity · Restriction · Nearby",
                fields: ["joined through their own tables"],
                kind: "support",
              },
            ],
          },
            ...
            entities: [
              {
                ...
                fields: [
                  "user, listing",
                  "start_date, end_date",
                  "total_price, guests_count",
                  "status: PENDING → ACCEPTED → COMPLETED",
                  "listing_type_at_booking",
                ],
                kind: "owned",
              },
              {
        ...
        relations: [
          { from: "user", to: "host", label: "one to one" },
          { from: "user", to: "biz", label: "one to one" },
          { from: "user", to: "listing", label: "owns many" },
          { from: "listing", to: "prop", label: "polymorphic child" },
          { from: "listing", to: "amen", label: "many to many" },
          { from: "listing", to: "booking", label: "one to many" },
          { from: "booking", to: "txn", label: "one to many" },
          { from: "booking", to: "review", label: "one to many" },
        ],
      },
      flow: {
    ...
    },
    {
      ...
      flow: {
        title: "Two browsers, one match",
        caption:
          "Fourteen games share one result shape, so a match, a leaderboard and a personal best are three readings of the same record rather than fourteen special cases.",
        lanes: [
          { id: "p1", label: "Player" },
          { id: "p2", label: "Opponent" },
          { id: "ws", label: "Channels" },
          { id: "db", label: "PostgreSQL" },
        ],
        steps: [
          {
            id: "c1",
            lane: "p1",
            label: "Opens a competitive game",
            note: null,
            state: null,
            kind: "step",
          },
          {
            id: "c2",
            lane: "ws",
            label: "Creates or joins a match",
            note: null,
            state: "waiting",
            kind: "step",
          },
          ...
          },
          {
            id: "c4",
            lane: "ws",
            label: "Fans every move to both",
            note: "Over the Redis channel layer",
            state: null,
            kind: "step",
          },
          {
          ...
          },
          {
            id: "c6",
            lane: "db",
            label: "Writes one GameResult",
            note: "The same shape all fourteen use",
            state: null,
            kind: "gate",
          },
          {
            id: "c7",
            lane: "db",
            label: "Updates best score and XP",
            note: "Streaks, mistakes, times played",
            state: "completed",
            kind: "end",
          },
        ],
